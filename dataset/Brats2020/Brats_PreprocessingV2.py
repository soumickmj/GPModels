...
if process == 1:
      source_root = f'{main_path}/{amount}/{orient}/MICCAI_BraTS2020_TrainingData/*'
elif process == 2:
...
for i in range(len(t1)):
      ...
      if process == 2:
                    # csv file name
            file_name = f"{main_path}/full/Axi/MICCAI_BraTS2020_TrainingData/name_mapping.csv"
            fields = ['Grade']
      ...
      destin_root = f'{main_path}/{amount}/{orient}/NonEmpty_MICCAI_BraTS2020_TrainingData/BraTS20_Training_00{number}'
